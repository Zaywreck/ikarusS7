...
ui.statusbar.showMessage("giris başarılı" + str(response_giris))
# response = Api_Get("https://savasaniha.baykartech.com/api/sunucusaati").json()
# json_data = json.loads(response) 
# # ui.serverTime_lbl.setText(response)
# server_gun = datetime.datetime.now().day
# server_saat = datetime.datetime.now().hour
# server_dakika = datetime.datetime.now().minute
# server_saniye = datetime.datetime.now().second
# server_milisaniye = datetime.datetime.now().microsecond
# server_gun = response[0]["gun"]
# server_saat = response[0]["saat"]
# server_dakika = response[0]["dakika"]
# server_saniye = response[0]["saniye"]
# server_milisaniye = response[0]["milisaniye"]
#
